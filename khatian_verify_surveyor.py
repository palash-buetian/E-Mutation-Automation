...
def credentials():
    ...
    username = config.get('SURVEYOR_LOGIN', 'username')
    password = config.get('SURVEYOR_LOGIN', 'password')
...
def new_case_found(processed=False):
    ...
    try:
        ...
        click_by_linktext("যাচাই এর জন্য অপেক্ষমাণ")
        return True
...
def show_info_in_terminal(details):
    # Terminal output
    print(details['application_details'] + " ===> Approved!")
